...
Releases are published through the repository's [GitHub Releases](../../releases) page when a version tag is pushed.

The application is published as a self-contained, single-file Windows x64 executable.

## Requirements

Building HSL locally requires the [.NET Core 3.1 SDK](https://dotnet.microsoft.com/en-us/download/dotnet/3.1). Published releases are self-contained and do not require a separate .NET installation.
